...
# 
api_key="b6d2129a0ed830fa97b746fc16b2dc021000242151" 			#api_key
api_token="bb845fc25aa8be8ab233b5efb8b4250e1245005667" 	#api_token
url="http://59.110.212.116:4999/server/?s=/api/open/fromComments" #同步到的url。使用www.showdoc.cc的不需要修改，使用开源版的请修改
#
#
#
#
