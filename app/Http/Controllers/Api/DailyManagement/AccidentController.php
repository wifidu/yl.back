...
class AccidentController extends Controller
{
    ...
    public function __construct(AccidentService $accidentService)
    {
         ...
         * @param type true varchar(128) 事故类型
    ...
    public function update(AccidentRequest $request) // 如果更新失败，说明数据重复
    {
         ...
         * @return_param id int 事故id
         * @return_param id true int 事故id
         * @return_param account_id false int  账户id
         * @return_param type false varchar(128) 事故类型
         * @return_param level_accident false tinyint(4) 事故等级, 0-轻微 1-一般　２-严重
         * @return_param occurrence_time false int(11) 发生时间
         * @return_param duty_personnel false varchar(128) 值班人员
         * @return_param head false varchar(32) 负责人
         * @return_param description false text 事故描述
         * @remark 备注
         */
