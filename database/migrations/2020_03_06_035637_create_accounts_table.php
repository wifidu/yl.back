...
class CreateAccountsTable extends Migration {
	...
	public function up()
	{
		Schema::create('accounts', function(Blueprint $table)
		{
			...
			$table->decimal('beds_cost', 10)->comment('床位费');
			$table->decimal('meal_cost', 10)->comment('餐费');
			$table->decimal('nursing_cost', 10)->comment('护理费');
			$table->decimal('other_cost', 10)->comment('其他月度费');
		});
	}
